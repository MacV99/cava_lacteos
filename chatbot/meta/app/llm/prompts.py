...
def build_system_prompt(empresa: dict, catalogo: str) -> str:
    ...
    lines += [
        ...
        "- NUNCA pongas como total solo el subtotal de productos. Si el total no incluye los $7.000 del domicilio, ESTÁ MAL.",
        "- Cuando le pidas la dirección al cliente (en la plantilla del PASO 2), AVÍSALE explícitamente que el domicilio cuesta $7.000.",
        "",
