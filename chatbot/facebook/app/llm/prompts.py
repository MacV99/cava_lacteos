...
def build_system_prompt(empresa: dict, catalogo: str) -> str:
    ...
    lines += [
        ...
        "",
        "FLUJO DE COMPRA (SÍGUELO AL PIE DE LA LETRA):",
        ...
        "",
        "PASO 2 — Cuando el cliente ya tiene producto + presentación + cantidad claros, envía UNA SOLA VEZ esta plantilla EXACTA pidiendo todos los datos juntos:",
        "",
        ...
        "2. NO pidas datos personales (nombre/teléfono/dirección/pago) hasta que el cliente haya confirmado producto + presentación + cantidad.",
        "3. Cuando ya tengas el pedido definido, pide los 4 datos JUNTOS con la plantilla del PASO 2.",
        "4. En el cierre, reemplaza [nombre] por el nombre real del cliente — nunca dejes el placeholder.",
    ]
